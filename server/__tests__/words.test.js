...
beforeEach(async () => {
  ...
  const testWord = new Word({
    word: 'test', hints: ['test1', 'test2'], category: 'testing', difficulty: 0,
  });
  await testWord.save();
});
...
describe('POST /words/word', () => {
  it('on success, should return the created result with an http status 200', async () => {
    const payload = {
      word: 'my word', hints: ['hint1', 'hint2'], category: 'word', difficulty: 0,
    };
...
describe('GET /words', () => {
  it('should return the list of all words', async () => {
    ...
    const newWord = new Word({
      word: 'new word', hints: ['test1', 'test2'], category: 'testing', difficulty: 0,
    });
    await newWord.save();
    const res = await supertest(server)
      .get('/words');
  ...
  it('should filter by the category when given a query parameter', async () => {
    ...
    const newWord = new Word({
      word: 'new word', hints: ['test1', 'test2'], category: 'another', difficulty: 0,
    });
    await newWord.save();
    const res = await supertest(server)
  ...
  it('should filter by the difficulty when given a query parameter', async () => {
    ...
    const newWord = new Word({
      word: 'new word', hints: ['test1', 'test2'], category: 'testing', difficulty: 1,
    });
    await newWord.save();
    const res = await supertest(server)
